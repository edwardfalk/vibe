...
| ---------------- | --------------------- | ------------------------------------------------------------------------------ | -------- |
| `GameLoop.js`    | 800, 600              | `CANVAS_WIDTH`, `CANVAS_HEIGHT` (GameLoopSetup.js)                             | ✅ Done (GameLoopSetup.js) |
...
| `AuroraWisps.js` | 100, 35, 0.006        | `AURORA_WISP_BASE_SIZE`, `AURORA_WISP_MODULATION`, `AURORA_PHASE_SPEED`       | ✅ Done  |
