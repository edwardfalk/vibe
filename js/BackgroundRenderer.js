    ...
    drawEnhancedSpaceElements(p = this.p) {
        ...
        for (let i = 0; i < 12; i++) {
            ...
            for (let j = 0; j < 5; j++) {
                ...
                p.ellipse(segmentX, segmentY, streamSize - j * 10, (streamSize - j * 10) * 0.6);
            }
        }
        ...
        for (let i = 0; i < 20; i++) {
            ...
            if (twinkle > 0.7) {
                ...
                p.line(sparkleX - sparkleSize, sparkleY, sparkleX + sparkleSize, sparkleY);
                p.line(sparkleX, sparkleY - sparkleSize, sparkleX, sparkleY + sparkleSize);
                p.noStroke();
            }
        }
